...
module Core.Managers {
    ...
    export class AnimationManager extends PIXI.utils.EventEmitter{
        ...
        private _animations: Array<Dev.Enum.AnimListener>;
        ...
        public playNextAnimations(): void {
            ...
            if (this._animations.length == 0) {
                ...
                let animations = Object.keys(Dev.Enum.AnimListener);
        ...
        public sortScenarioAnimation(animations:Array<Dev.Enum.AnimListener>): void {
