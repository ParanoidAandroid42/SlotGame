...
namespace Dev.Modules { 
    ...
    export abstract class Machine extends PIXI.utils.EventEmitter {
        ...
        public matrixSymbols: Array<Array<Symbol>> = new Array<Array<Symbol>>();
        ...
        public constructor(slotMachineConfig: Interface.ISlotConfig,container:Core.Modules.Container) {
            ...
            this.container = new Core.Modules.Container(0,0,container, "MachineContainer");
            this.baseReelContainer = new Core.Modules.Container(0,-10,this.container, "ReelContainer");
            this.initProperties();
        }
        ...
        public abstract playLoopAnimation(wins:Array<Interface.IWData>,duration:number,loopingTime:number):void;
        ...
        public abstract stopLoopAnimation():void;
